...
<head>
    ...
    <style>
        .register_content {  width: 360px;  padding-top: 40px;  min-height: 400px;  font-size: 14px;  margin-left: 540px;  }
        .register_wrap{min-height: 500px;}
        .register_left{    position: relative;  z-index: 9;  float: left;  left: 150px;  top: 35px;}
        .register_left p:nth-of-type(1){font-size: 24px;line-height: 50px;}
        .register_left p:nth-of-type(2){font-size: 15px;line-height: 35px;}
        .register_left p:nth-of-type(3){font-size: 15px;color: #fd5f30;line-height: 35px;}
        .register_left p:nth-of-type(4){font-size: 15px;line-height: 35px;}
        .register_left p:nth-of-type(5){font-size: 15px;line-height: 35px;color: #fd5f30;}
        .register_left img{width: 196px;height: 196px;margin-top: 15px;}

        .data_item{position:relative;width:390px;min-height:55px;padding-bottom:5px}
...
<div style="min-height: 69vh;">
    <div class="register_wrap" style="margin-top: 32px;">
        <!--增加的代码-->
            ...
            <div class="data_item">
                ...
                <div class="input_wrap">
                    <div class="border_wrap">
                        ...
                        <input class="reg_rcode form-control" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" placeholder="请输入注册码" maxlength="6" />
                    </div>
                    <p></p>
                    <i class="error"></i>
                </div>
