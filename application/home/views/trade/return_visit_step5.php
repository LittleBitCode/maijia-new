...
<body>
    ...
    <form action="/trade/return_visit_step5_submit/<?php echo $trade_info->id; ?>" method="post" id="pay_business_task">
    <div class="trade_box">
        <div class="step5_box">
            ...
            <div class="white_box">
                ...
                <div class="pay_type">
                    <div class="pay_list_box">
                        ...
                        <!-- <div class="pay_list_type">
                            <div class="pay_type_check"><label><input type="radio" name="pay_type" />使用<span>工商银行</span>支付</label><a href="javascript:;">共有17个网银支付方式，点击选择</a><p>支付：<em class="points_pay_number">100.00</em>点</p></div>
                            <div class="pay_type_check"><label><input type="radio" name="pay_type" />使用<span>微信</span>支付</label><p>支付：<em class="points_pay_number">100.00</em>点</p></div>
                            <div class="pay_type_check"><label><input type="radio" name="pay_type" />使用<span>支付宝</span>支付</label><p>支付：<em class="points_pay_number">100.00</em>点</p></div>
                            <div class="pay_type_check"><label><input type="radio" name="pay_type" />使用<span>建设银行</span>支付</label><p>支付：<em class="points_pay_number">100.00</em>点</p></div>
                            <div class="pay_type_check"><label><input type="radio" name="pay_type" />使用<span>中国银行</span>支付</label><p>支付：<em class="points_pay_number">100.00</em>点</p></div>
                            <div class="pay_type_check"><label><input type="radio" name="pay_type" />使用<span>农业银行</span>支付</label><p>支付：<em class="points_pay_number">100.00</em>点</p></div>
                            <div class="pay_type_check"><label><input type="radio" name="pay_type" />使用<span>民生银行</span>支付</label><p>支付：<em class="points_pay_number">100.00</em>点</p></div>
                            <div class="pay_type_check"><label><input type="radio" name="pay_type" />使用<span>招商银行</span>支付</label><p>支付：<em class="points_pay_number">100.00</em>点</p></div>
                            <div class="pay_type_check"><label><input type="radio" name="pay_type" />使用<span>浦发银行</span>支付</label><p>支付：<em class="points_pay_number">100.00</em>点</p></div>
                            
                            <div class="pay_type_check"><label><input type="radio" name="pay_type" />使用<span>广发银行</span>支付</label><p>支付：<em class="points_pay_number">100.00</em>点</p></div>
                            <div class="pay_type_check"><label><input type="radio" name="pay_type" />使用<span>光大银行</span>支付</label><p>支付：<em class="points_pay_number">100.00</em>点</p></div>
                            <div class="pay_type_check"><label><input type="radio" name="pay_type" />使用<span>交通银行</span>支付</label><p>支付：<em class="points_pay_number">100.00</em>点</p></div>
                            <div class="pay_type_check"><label><input type="radio" name="pay_type" />使用<span>兴业银行</span>支付</label><p>支付：<em class="points_pay_number">100.00</em>点</p></div>
                            <div class="pay_type_check"><label><input type="radio" name="pay_type" />使用<span>中信银行</span>支付</label><p>支付：<em class="points_pay_number">100.00</em>点</p></div>
                            <div class="pay_type_check"><label><input type="radio" name="pay_type" />使用<span>深发银行</span>支付</label><p>支付：<em class="points_pay_number">100.00</em>点</p></div>
                            <div class="pay_type_check"><label><input type="radio" name="pay_type" />使用<span>邮政储蓄</span>支付</label><p>支付：<em class="points_pay_number">100.00</em>点</p></div>
                            <div class="pay_type_check"><label><input type="radio" name="pay_type" />使用<span>块钱</span>支付</label><p>支付：<em class="points_pay_number">100.00</em>点</p></div>
                        </div> -->
                    </div>
