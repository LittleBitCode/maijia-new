...
<body>
    ...
    <div class="trade_box">
        <div class="step3_box">
            ...
            <div class="white_box">
                <h3>3.下单提示<span class="red">注：买手接活动时可看见该提示，提示内容自由填写，如：商品在第*页*行、聊天时不要问发货地和哪家快递等。属可选项，限<em>255</em>字内。</span></h3></textarea>
...
$(function(){
    ...
    $(".next_step").click(function () {
        ...
        if (distribution_num != sd_number) {
            toastr.warning('订单总数需为' + sd_number + '单');
            return false;
        } else {
            ...
            $.ajax({
                type: "POST",
                url: "/trade/return_visit_step3_submit/<?php echo $trade_info->id; ?>",
                data: {
                    "total_num": total_num,
