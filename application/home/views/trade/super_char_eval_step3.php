...
<div class="trade_top contain">
    <div class="Process">
        <ul class="clearfix">
            ...
            <li style="width:16%"><em class="Processyes">3</em><span>填写下单商品信息</span></li>
...
<script type="text/javascript">
    $(function(){
        ...
        $("body").on("click", ".one_button", function () {
            ...
            $.ajax({
                type: "POST",
                url: "/trade/super_char_eval_step3_1_submit/" + _trade_id,
                data: {
                    "goods_url": goods_url,
        ...
        $(".two_but_box").click(function(){
            ...
            $.ajax({
                type: "POST",
                url: "/trade/super_char_eval_step3_2_submit/" + _trade_id,
        ...
        $('.trade_box').on('click','.next_step',function(){
            $.ajax({
                type: "POST",
                url: "/trade/super_char_eval_step3_3_submit/" + _trade_id,
                data: {"a": 1},
                datatype: "json",
                success: function(d) {
