...
<div class="trade_top">
    <div class="Process">
        <ul class="clearfix">
            ...
            <li style="width:16%" class="cur"><em class="Processyes">5</em><span>选增值服务</span></li>
            <li style="width:17%"><em class="Processyes">6</em><span>支付</span></li>
            <li style="width:17%" class="Processlast"><em>7</em><span>发布成功</span></li>
        </ul>
    </div>
</div>
<div style="clear: both;"></div>
<form action="/trade/super_char_eval_step6_submit/<?php echo $trade_info->id; ?>" method="post" id="pay_business_task">
    <div class="trade_box">
        <!-- 发活动顶部活动步骤进度start -->
        <div class="step5_box">
            <h1>6.支付<span>&nbsp;&nbsp;&nbsp;充值到账可能会有延时，若<span class="red">30分钟</span>内未到账请联系客服</span></h1>
...
<script type="text/javascript">
    ...
    // var points_number = parseFloat(points_number); //需要支付押金
    ...
    // 		var lack = points_number-recharge;
    // 		$('.lack_deposit').prepend('押金还差'+ lack);
    // 	}
    // }else{
