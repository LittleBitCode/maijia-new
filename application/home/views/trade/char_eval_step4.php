...
<div class="trade_box">
    ...
    <div class="step4_box">
        ...
        <div class="service_box">
            ...
            <h3 class="tit_img" style="<?= $trade_info->trade_type == '111' ? 'display:none' : '' ?>"><img src="/static/imgs/icon/ic7.png" />快递选项</h3>
            <div class="time_task_box step4_white" style="<?= $trade_info->trade_type == '111' ? 'display:none' : '' ?>">
            ...
            <?php if($trade_info->trade_type != '111') : ?>
...
<script src="/static/js/task_img_upload.js?v=1"></script>
<script type="text/javascript">
    ...
    $(function(){
        ...
        $("body").on("click", ".next_step", function () {
            ...
            $.ajax({
                type: "POST",
                url: "/trade/char_eval_step4_submit/" + _trade_id,
                data: {
