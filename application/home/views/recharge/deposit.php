...
<style>
	*{
	...
	.active {
	    ...
	    background-image: url(/static/imgs/icon/border_bg.png);
...
<!--						<a  class="canChoice alipay --><?//= ('alipay' == $type) ? 'active' : ''; ?><!--" data-type="alipay" href="/recharge/deposit/alipay">-->
<!--							<img src="/static/imgs/icon/charge_nav_2.png" alt="">-->
<!--							<li>支付宝</li>-->
<!--						</a>-->
						<a  class="canChoice bank <?= ('bank' == $type) ? 'active' : ''; ?>" data-type="bank" href="/recharge/deposit/bank">
							<img src="/static/imgs/icon/charge_nav_3.png" alt="">
							<li>银行转账</li>
						</a>
<!--						<a  class="canChoice unionpay --><?//= ('unionpay' == $type) ? 'active' : ''; ?><!--" data-type="unionpay" href="/recharge/deposit/unionpay">-->
<!--							<img src="/static/imgs/icon/charge_nav_4.png" alt="">-->
<!--							<li>网银支付</li>-->
<!--						</a>-->
						<!--<a href="/taoindex/member/detailed" class="sel">
							<img src="/static/imgs/icon/charge_nav_5.png" alt="">
							<li>资金明细</li>
						</a>-->
					</ul>
                </div>
                                ...
                                <form id="deposit_form" action="/recharge/deposit_submit" method="post" target="_blank">
                                    ...
                                    <div class="bank_list">
                                        <ul>
                                            ...
                                            <?php foreach ($bank_pay_list as $key => $item): if ($item['is_show'] != '1') continue; $idx++; ?>
                                                <li pay_id="<?= $key ?>" style="<?= ($idx % 5 == 0) ? 'margin-right:22px' : ''; ?>" class="<?= ($idx==1) ? 'cur' : ''; ?>"><i></i><img src="<?= $item['img'] ?>" alt="" style="top:0;margin-right:6px;"/><?= $item['title']; ?></li>
                                            <?php endforeach; ?>
                                        </ul>
                                    </div>
                                    <div class="recharge_number" style="">
                                        ...
                                        <div class="recharge_number_con">
                                            ...
                                            <input type="button" class="recharge_butt" value="确&nbsp;&nbsp;认" style='background-color: #ff6b71;border: 1px solid #ff6b71;'/>
                                        </div>
                                    </div>
                                </form>
                            </div>
