...
class Conf_Model extends CI_Model {
    ...
    public function trade_type_list($plat_id) {
        if (in_array($plat_id, [1, 2])) {
            return [
                '1' => ['type_name' => '普通搜索订单&nbsp;（支持指定文字、关键词、图文、视频评价）', 'limit_point' => '6.80', 'comment' => '买家通过商家提供的关键词，从淘宝，天猫，手淘APP通过自然搜索入店找到商品，之后完成下单等操作；确认收货后，会根据商家提供的好评关键词进行评价，有利于优化商品评价标签。'],
                '90' => ['type_name' => '超级搜索订单&nbsp;（竞品流量劫持；超级精准打标；手淘首页流量截取；双关键词（长尾词搜索，核心词成交））', 'limit_point' => '7.80', 'comment' => '买家预先通过商家提供的多个指定的关键词与商品进行浏览之后，再通过指定的关键词找到自己的商品进行下单购买，此活动可以通过优秀的竞争对手产品进行强行打标，然后获取更大的权重值！'],
                '2' => ['type_name' => '回访订单（首日加购、次日下单）', 'limit_point' => '10.80', 'comment' => '买家第一天通过商家提供的关键词，从淘宝，天猫，手淘APP通过自然搜索入店找到商品，然后加入购物车；第二天买手通过购物车，完成下单等操作；确认收货后，会根据商家提供的好评关键词进行评价，有利于优化商品加购权重及加购购买权重。'],
                ...
                '4' => ['type_name' => '聚划算', 'limit_point' => '6.80', 'comment' => '买家通过聚划算入店，找到商家的聚划算商品后下单；买家确认收货后，会根据商家的要求进行好评等操作。'],
                '5' => ['type_name' => '淘抢购', 'limit_point' => '6.80', 'comment' => '买家通过手淘APP入店，找到商家的淘抢购商品后下单；买家确认收货后，会根据商家的要求进行好评等操作。'],
