...
class Conf_Model extends CI_Model {
    ...
    public function trade_type_list($plat_id) {
        if (in_array($plat_id, [1, 2])) {
            return [
                '1' => ['type_name' => '普通搜索订单&nbsp;（支持指定文字、关键词、图文、视频评价）', 'limit_point' => '4.80', 'comment' => '买家通过商家提供的关键词，从淘宝，天猫，手淘APP通过自然搜索入店找到商品，之后完成下单等操作；确认收货后，会根据商家提供的好评关键词进行评价，有利于优化商品评价标签。'],
                '90' => ['type_name' => '超级搜索订单&nbsp;（竞品流量劫持；超级精准打标；手淘首页流量截取；双关键词（长尾词搜索，核心词成交））', 'limit_point' => '5.80', 'comment' => '买家预先通过商家提供的多个指定的关键词与商品进行浏览之后，再通过指定的关键词找到自己的商品进行下单购买，此活动可以通过优秀的竞争对手产品进行强行打标，然后获取更大的权重值！'],
                '2' => ['type_name' => '回访订单（首日加购、次日下单）', 'limit_point' => '8.80', 'comment' => '买家第一天通过商家提供的关键词，从淘宝，天猫，手淘APP通过自然搜索入店找到商品，然后加入购物车；第二天买手通过购物车，完成下单等操作；确认收货后，会根据商家提供的好评关键词进行评价，有利于优化商品加购权重及加购购买权重。'],
                // '3' => ['type_name' => '普通搜索订单+图文好评', 'limit_point' => '12.40', 'comment' => '买家通过商家提供的关键词，从淘宝，天猫，手淘APP通过自然搜索入店找到商品，之后完成下单等操作；确认收货后，会根据商家提供的好评图片进行评价，有利于优化评价内容及转化率。'],
                '4' => ['type_name' => '聚划算', 'limit_point' => '4.80', 'comment' => '买家通过聚划算入店，找到商家的聚划算商品后下单；买家确认收货后，会根据商家的要求进行好评等操作。'],
                '5' => ['type_name' => '淘抢购', 'limit_point' => '4.80', 'comment' => '买家通过手淘APP入店，找到商家的淘抢购商品后下单；买家确认收货后，会根据商家的要求进行好评等操作。'],
                '10' => ['type_name' => '流量订单', 'limit_point' => '0.8', 'comment' => '买家通过任务关键词进店，完成搜索、点击、收藏、加购等操作，适合多数类目商品。快速提高关键词无线端展现，提升无线端排名和收藏加购等人气权重，带来真实流量。'],
                //'111' => ['type_name' => '双十一定金任务', 'limit_point' => '4.80', 'comment' => '买家通过任务关键词进店，完成搜索、点击、收藏、支付定金等操作，买家支付完成之后，无需支付尾款，并直接给用户进行返款，因为定金不退。'],
                //'112' => ['type_name' => '双十一定金+尾款任务', 'limit_point' => '8.80', 'comment' => '买家通过任务关键词进店，完成搜索、点击、收藏、支付定金+尾款等操作，买家支付完成之后，双十一当天支付尾款。确认收货后，会根据商家提供的好评关键词进行评价，有利于优化商品加购权重及加购购买权重'],
                //'114' => ['type_name' => '双十一回访订单', 'limit_point' => '8.80', 'comment' => '买家第一天通过商家提供的关键词，从淘宝，天猫，手淘APP通过自然搜索入店找到商品，然后加入购物车；双十一当天买手通过购物车，完成下单等操作；确认收货后，会根据商家提供的好评关键词进行评价，有利于优化商品加购权重及加购购买权重。'],
                //'115' => ['type_name' => '双十一退款订单（默认 2019-11-10 23:57:00 发出）', 'limit_point' => '3.80', 'comment' => '买家双十一当天通过任务关键词进店，完成搜索、点击、收藏、加购，下单等操作，次日进行退款操作，此任务有效提升双十一当天赛马坑产排名'],
                //'211' => ['type_name' => '双十二定金任务', 'limit_point' => '4.80', 'comment' => '买家通过任务关键词进店，完成搜索、点击、收藏、支付定金等操作，买家支付完成之后，无需支付尾款，并直接给用户进行返款，因为定金不退。'],
                //'212' => ['type_name' => '双十二定金+尾款任务', 'limit_point' => '8.80', 'comment' => '买家通过任务关键词进店，完成搜索、点击、收藏、支付定金+尾款等操作，买家支付完成之后，双十二当天支付尾款。确认收货后，会根据商家提供的好评关键词进行评价，有利于优化商品加购权重及加购购买权重'],
                //'214' => ['type_name' => '双十二回访订单', 'limit_point' => '8.80', 'comment' => '买家第一天通过商家提供的关键词，从淘宝，天猫，手淘APP通过自然搜索入店找到商品，然后加入购物车；双十二当天买手通过购物车，完成下单等操作；确认收货后，会根据商家提供的好评关键词进行评价，有利于优化商品加购权重及加购购买权重。'],
            ...
            return [
                '6' => ['type_name' => '普通搜索订单&nbsp;（支持指定文字、关键词、图文、视频评价）', 'limit_point' => '8.70', 'comment' => '买家通过商家提供的关键词，从京东，手机APP通过自然搜索入店找到商品，之后完成下单等操作；确认收货后，会根据商家提供的好评关键词进行评价，有利于优化商品评价标签。'],
                '7' => ['type_name' => '链接直拍', 'limit_point' => '7.70', 'comment' => '买家通过商家提供的商家链接，直接进入商品页，完成浏览、下单等操作；确认收货后，会根据商家提供的好评关键词进行评价。'],
                '10' => ['type_name' => '流量订单', 'limit_point' => '0.8', 'comment' => '买家通过任务关键词进店，完成搜索、点击、收藏、加购等操作，适合多数类目商品。快速提高关键词无线端展现，提升无线端排名和收藏加购等人气权重，带来真实流量。']
            ];
        } elseif ($plat_id == '14') {
            return [
                '140' => ['type_name' => '普通搜索订单&nbsp;（支持指定文字、关键词、图文、视频评价）', 'limit_point' => '6.0', 'comment' => '买家通过商家提供的关键词，从拼多多手机APP通过自然搜索入店找到商品，之后完成下单等操作；确认收货后，会根据商家提供的好评关键词进行评价，有利于优化商品评价标签。'],
            ];
        }
    }
    ...
    public function get_shipping_type_list($type = null) {
        $list = [
            ...
            'yto' => ['name' => '圆通快递', 'price' => 3, 'default' => 0, 'is_show' => 1],
...
//            ['account' => '6217711118678299', 'account_name' => '李永超', 'bank_name' => '中信银行'],
            ['account' => '6217711119696753', 'account_name' => '王晨光', 'bank_name' => '中信银行'],
        ];
    }
