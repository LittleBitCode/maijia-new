    ...
    public function cancel_refund($trade_info)
    {
        ...
        if ($trade_info->trade_status == '1') {
            ...
            if ($trade_info->total_num == $order_cnts->not_started) {
                ...
                $average_refund_list = ['plat_refund', 'bus_refund', 'set_traffic', 'add_reward', 'kwd_eval', 'setting_eval', 'add_reward_ext', 'set_shipping', 'shopping_end', 'area_limit', 'sex_limit', 'reputation_limit', 'taoqi_limit', 'setting_picture', 'traffic_list', 'newhand', 'super_scan'];
                foreach ($trade_service as $v) {
