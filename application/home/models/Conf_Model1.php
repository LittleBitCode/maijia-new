...
class Conf_Model extends CI_Model {
    ...
    public function trade_type_list($plat_id) {
        if (in_array($plat_id, [1, 2])) {
            return [
                '1' => ['type_name' => '普通搜索订单', 'limit_point' => '10.40', 'comment' => '买家通过商家提供的关键词，从淘宝，天猫，手淘APP通过自然搜索入店找到商品，之后完成下单等操作；确认收货后，会根据商家提供的好评关键词进行评价，有利于优化商品评价标签。'],
                '2' => ['type_name' => '回访订单（首日加购、次日下单）', 'limit_point' => '14.40', 'comment' => '买家第一天通过商家提供的关键词，从淘宝，天猫，手淘APP通过自然搜索入店找到商品，然后加入购物车；第二天买手通过购物车，完成下单等操作；确认收货后，会根据商家提供的好评关键词进行评价，有利于优化商品加购权重及加购购买权重。'],
                ...
                '4' => ['type_name' => '聚划算', 'limit_point' => '10.40', 'comment' => '买家通过聚划算入店，找到商家的聚划算商品后下单；买家确认收货后，会根据商家的要求进行好评等操作。'],
                '5' => ['type_name' => '淘抢购', 'limit_point' => '10.40', 'comment' => '买家通过手淘APP入店，找到商家的淘抢购商品后下单；买家确认收货后，会根据商家的要求进行好评等操作。'],
                '10' => ['type_name' => '流量订单', 'limit_point' => '0.8', 'comment' => '买家通过任务关键词进店，完成搜索、点击、收藏、加购等操作，适合多数类目商品。快速提高关键词无线端展现，提升无线端排名和收藏加购等人气权重，带来真实流量。']
            ];
        } elseif ($plat_id == '4') {
            return [
                '6' => ['type_name' => '普通搜索订单', 'limit_point' => '8.70', 'comment' => '买家通过商家提供的关键词，从京东，手机APP通过自然搜索入店找到商品，之后完成下单等操作；确认收货后，会根据商家提供的好评关键词进行评价，有利于优化商品评价标签。'],
                '7' => ['type_name' => '链接直拍', 'limit_point' => '7.70', 'comment' => '买家通过商家提供的商家链接，直接进入商品页，完成浏览、下单等操作；确认收货后，会根据商家提供的好评关键词进行评价。'],
                '10' => ['type_name' => '流量订单', 'limit_point' => '0.8', 'comment' => '买家通过任务关键词进店，完成搜索、点击、收藏、加购等操作，适合多数类目商品。快速提高关键词无线端展现，提升无线端排名和收藏加购等人气权重，带来真实流量。']
            ];
        } elseif ($plat_id == '14') {
            return [
                '140' => ['type_name' => '普通搜索订单', 'limit_point' => '6.0', 'comment' => '买家通过商家提供的关键词，从拼多多手机APP通过自然搜索入店找到商品，之后完成下单等操作；确认收货后，会根据商家提供的好评关键词进行评价，有利于优化商品评价标签。'],
            ];
        }
    }
    ...
    public function get_shipping_type_list($type = null) {
        $list = [
            ...
            'yto' => ['name' => '圆通快递', 'price' => 3, 'default' => 0, 'is_show' => 0],
            'zto' => ['name' => '中通快递', 'price' => 3, 'default' => 0, 'is_show' => 0],
    ...
    public function get_recharge_alipay_account()
    {
        return [
            ...
            ['qrcode' => '/static/imgs/alipay/qr_20190603_y.png', 'name' => '易思成'],
    ...
    {
        return [
            ['account' => '6217710810667766', 'account_name' => '王园园', 'bank_name' => '中信银行'],
            ['account' => '6217710810667758', 'account_name' => '于玲玲', 'bank_name' => '中信银行'],
        ];
    }
